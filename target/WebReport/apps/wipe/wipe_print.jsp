...
<table width="700px;" cellpadding="0" cellspacing="0" class="form" border="1">
<tr>
<td><span style="font-size:11pt;">经费项目</span></td><td><span style="font-size:11pt;"> 日 期</span></td><td><span style="font-size:11pt;">报销金额</span></td><td><span style="font-size:11pt;">摘要</span></td><td><span style="font-size:11pt;">备注</span></td>
</tr>
...
<td><span style="font-size:11pt;"><s:property value="itemDetailDate"/></span></td>
<td><span style="font-size:11pt;"><s:property value="itemDetailMoney"/></span></td>
<td><span style="font-size:11pt;"><s:property value="itemDetailBrief"/></span></td>
<td><span style="font-size:11pt;"><s:property value="itemDetailRemark"/></span></td>
</tr>
</s:iterator>
</table>
</td>
...
<tr>
<td colspan="3"><span style="font-size:12pt;">四、指示事项</span>
<br>
<s:iterator value="wipe.judgeSet" id="stat" >
<s:if test='#stat.jDirect!=null&&#stat.jDirect!=""'>
<span style="font-size:11pt;">
<s:property value="user.rName"/> :<s:property value="jDirect"/>
</span><br></s:if>
<s:else>
&nbsp;
</s:else>
...
<tr>
<td colspan="3"><span style="font-size:12pt;">五、备注</span>
<s:property value="wRemark"/>
</td>
</tr> 
