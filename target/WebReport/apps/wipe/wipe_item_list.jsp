...
<body>
	...
	<s:url id="checkUrl" action="wipeItem_prepareForEdit" includeParams="none" namespace="/"/>
		<ec:table items="page.result" var="wipeItem" action="./wipeItem_list.action" width="100%" listWidth="100%" resizeColWidth="true" doPreload="false">
			<ec:row>
			...
			<s:if test="#attr.reApply=='reApply'">
				<s:a href="wipeItemDetail_list.action">下一步</s:a>
            </s:if>
