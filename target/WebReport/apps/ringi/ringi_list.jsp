...
<body>
	<s:include value="/apps/pageHeader.jsp">
		...
		<s:param name="fb_add"><s:url action="ringi_leave" includeParams="none" namespace="/"/></s:param>
	</s:include>
	...
	<s:url id="editUrl" action="ringi_edit" includeParams="none" namespace="/"/>
		<ec:table items="ringiShoTaskList" var="rt" action="./ringi_list.action" width="100%" listWidth="100%" resizeColWidth="true">
			<ec:row>
				...
				<ec:column property="task.id" title="操作" width="10%" style="text-align:center">
					<s:if test="%{#attr.rt.task.name == '填写禀议书'}">
