...
<body>
	...
	<s:url id="viewUrl" action="ringi_review" includeParams="none" namespace="/"/>
		<ec:table items="ringiShoTaskList" var="rt" action="./ringi_pendingTasks.action" toolbarContent="navigation|refresh|status" sortable="false" width="100%" listWidth="100%" resizeColWidth="true">
			<ec:row>
