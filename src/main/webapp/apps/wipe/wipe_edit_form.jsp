			...
			<tbody>
				...
				<tr id="tr_3"><td>三级决裁</td>
					...
					<td>
					    ...
					    <s:hidden name="wipe.judgeSet[4].user.id"  id="wujiId"/>
						<s:hidden name="wipe.judgeSet[4].user.rName"  id="wujiName"/>
					</td>
				</tr>			
				</s:if>
				<s:else>
				...
				<td>三级决裁</td>
					...
					<td>
					    ...
					    <s:hidden name="wipe.judgeSet[4].user.id"  id="wujiId" disabled="true"/>
						<s:hidden name="wipe.judgeSet[4].user.rName"  id="wujiName" disabled="true"/>
					</td>
				</tr>	
				</s:else>
...
<table width="650px;" cellpadding="0" cellspacing="1" class="form"><tr><td align="center"  >
 <input type="button" value="修改" id="updBtn">
