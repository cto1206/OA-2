...
<center>
	<table style="width:700px;margin-top:50px;" cellpadding="1" cellspacing="0">
		<tr>
			<td style="text-align:center;vertical-align:top;border-bottom:1px black solid;width:60px;">
		...
		<tr>
			<td colspan="3">
				<table style="width:700px;border:1px black solid;" cellpadding="0" cellspacing="0">
					<tr style="height:35px;">
